...
Этот проект представляет собой приложение для анализа финансовых транзакций, которое позволяет пользователям 
загружать данные о транзакциях из файлов Excel, CSV или JSON, генерировать отчёты по категориям расходов и 
отображать финансовую информацию, включая курсы валют и цены акций. Проект реализован на Python с использованием 
библиотек `pandas`, `requests`, и `python-dotenv` для работы с данными, API и конфигурацией.
